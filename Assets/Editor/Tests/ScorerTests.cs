...
using System.Collections.Generic;
    ...
    public class ScorerTests
    {
        ...
        public void Initialize()
        {
            ...
            scorer.Initialize(); // Also sets the singleton.
        }
        ...
        public void FullScenario()
        {
            ...
            Scorer.Instance.ResetForNewImage();
            ...
            List<string> second = new List<string>(new string[] { "That's like", "Mario", "but", "blue", "." });
            ...
            Scorer.Instance.EvaluatePlayerPhrase(first, unknownWords, image.linkedWords);
            ...
            Scorer.Instance.EvaluatePlayerPhrase(second, unknownWords, image.linkedWords);
            ...
            Scorer.Instance.EvaluatePlayerPhrase(third, unknownWords, image.linkedWords);
